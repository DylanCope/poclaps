...
def reproduce_figure():
    data = [
        ...
        for csv_path in sorted(
            Path("figures/state_decoding_23-11-24-larger-model/goal_predictions").glob(
                "data_*.csv"
            )
        )
    ]
    ...
    plt.savefig(
        "figures/state_decoding_23-11-24-larger-model/goal_predictions/goal_predictions.pdf",
        bbox_inches="tight",
        dpi=1000,
    )
