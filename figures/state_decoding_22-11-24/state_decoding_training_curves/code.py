...
def reproduce_figure():
    data = [
        ...
        for csv_path in sorted(
            Path("figures/state_decoding_22-11-24/state_decoding_training_curves").glob(
                "data_*.csv"
            )
        )
    ]
    ...
    plt.savefig(
        "figures/state_decoding_22-11-24/state_decoding_training_curves/state_decoding_training_curves.pdf",
        bbox_inches="tight",
        dpi=1000,
    )
